...
export default function ServicesPage() {
  return (
    <PageTemplate>
      ...
      {/* Hero */}
      <HeroSection
        title="SERVICES THAT DRIVE BUSINESS"
        highlight="IMPACT"
        description="We deliver comprehensive ServiceNow solutions that transform your operations and drive measurable results."
        variant="simple"
      />
